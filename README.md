...
| **US21** | Consulta de animales asignados | Como Voluntario, quiero ver los animales asignados a mi cuidado para organizar mejor mis actividades dentro del refugio. | **Escenario 1 - Lista de animales asignados:**<br>Dado que el Voluntario inicia sesión.<br>Cuando accede a la sección de animales asignados.<br>Entonces el sistema mostrará la lista correspondiente.<br><br>**Escenario 2 - Sin animales asignados:**<br>Dado que el Voluntario no tiene animales asignados.<br>Cuando accede a la sección.<br>Entonces el sistema mostrará un mensaje indicando que no tiene asignaciones pendientes. | EP03 |
| **US22** | Visualización de tareas de cuidado | Como Voluntario, quiero visualizar mis tareas de cuidado para cumplir con las actividades asignadas en el refugio. | **Escenario 1 - Tareas disponibles:**<br>Dado que el Voluntario tiene tareas asignadas.<br>Cuando ingresa al módulo de tareas.<br>Entonces el sistema mostrará las actividades pendientes.<br><br>**Escenario 2 - Tarea completada:**<br>Dado que el Voluntario terminó una actividad.<br>Cuando marca la tarea como completada.<br>Entonces el sistema actualizará su estado. | EP03 |
| **US23** | Registro de incidente por voluntario   | Como Voluntario, quiero reportar incidentes observados en el refugio para que el administrador pueda revisarlos oportunamente. | **Escenario 1 - Registro de incidente:**<br>Dado que el Voluntario observa un problema con un animal.<br>Cuando registra el incidente en la plataforma.<br>Entonces el sistema guardará el reporte y notificará al Administrador.<br><br>**Escenario 2 - Incidente sin descripción:**<br>Dado que el Voluntario intenta registrar un incidente.<br>Cuando no ingresa una descripción.<br>Entonces el sistema mostrará un mensaje solicitando completar la información. | EP03 |
| **US24** | Consulta de información para adopción | Como Voluntario, quiero consultar información básica de animales disponibles para adopción para apoyar el proceso de difusión. | **Escenario 1 - Lista de animales disponibles:**<br>Dado que el Voluntario accede al módulo de adopciones.<br>Cuando existen animales disponibles.<br>Entonces el sistema mostrará su información básica.<br><br>**Escenario 2 - Animal no disponible:**<br>Dado que un animal no está habilitado para adopción.<br>Cuando el Voluntario revisa la lista.<br>Entonces el sistema no lo mostrará como disponible. | EP03 |
| **US25** | Confirmación de actividades realizadas | Como Voluntario, quiero confirmar las actividades realizadas para que el refugio tenga trazabilidad del cuidado diario. | **Escenario 1 - Confirmación exitosa:**<br>Dado que el Voluntario completó una actividad.<br>Cuando confirma la actividad en el sistema.<br>Entonces el sistema registrará la fecha, hora y usuario responsable.<br><br>**Escenario 2 - Actividad ya confirmada:**<br>Dado que una actividad ya fue registrada como completada.<br>Cuando el Voluntario intenta confirmarla nuevamente.<br>Entonces el sistema mostrará que la actividad ya fue realizada. | EP03 |
